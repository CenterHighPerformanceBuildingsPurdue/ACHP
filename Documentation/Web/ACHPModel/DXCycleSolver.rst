...
:math:`\Delta p_{cond}`          Pressure drop in condenser [Pa]
:math:`\Delta p_{evap}`          Pressure drop in evaporator [Pa]
:math:`\Delta p_{high}`          Pressure drop on high-pressure side of system [Pa]
:math:`\Delta p_{liquid-line}`   Pressure drop in liquid line [Pa]
:math:`\Delta p_{low}`           Pressure drop on low-pressure side of system [Pa]
:math:`\Delta p_{vapor-line}`    Pressure drop in vapor line [Pa]
:math:`p_{evap}^*`               Effective evaporation saturation pressure [Pa]
:math:`p_{cond}^*`               Effective condensing saturation pressure [Pa]
