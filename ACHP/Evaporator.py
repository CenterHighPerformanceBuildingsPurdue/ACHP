...
from scipy.optimize import brentq, fsolve, newton, fminbound #solver to find roots (zero points) of functions
...
class EvaporatorClass():
    ...
    def Calculate_PD(self):
        ...
        def objective_evaporator2p(DP_guess):
            ...
            self.Calculate()
            if printDP_iteration: 
                print "x2 guess",DP_guess,
        ...
        if printDP:
            print "DP_2Pguess is",DP_guess," with 2-phase fraction ",self.w_2phase,"bounds",lower_fminbound,(DP_guess*1.5,50-self.pin_r),self.mdot_r
        ...
        if printDP:
            print "DP_2Pacrtual is",self.DP_r_2phase," with 2-phase fraction ",self.w_2phase
        ...
        if self.existsSuperheat==True:
            ...
            if printDP:
                print "DP_1Pguess is",DP_guess, lower_fminbound,(DP_guess*1.5,10-self.pin_r-self.DP_r_2phase)
            try:
            ...
            if printDP:
                print "DP_1Pacrtual is",self.DP_r_superheat,"resulting in an outlet pressure of",self.pin_r+self.DP_r_superheat+self.DP_r_2phase
